...
<CodeBlock title="Success">
  <ExpandableSearchBar
    ...
    placeholder="Yess!"
    alwaysActive={true}
    message={{ text: "Okay, this is cool.", type: SEARCHBAR_MESSAGE_TYPES.SUCCESS }}
  />
</CodeBlock>
...
<CodeBlock title="Warning">
  <ExpandableSearchBar
    ...
    placeholder="Huh!"
    alwaysActive={true}
    message={{ text: "Okay, this is kinda cool.", type: SEARCHBAR_MESSAGE_TYPES.WARNING }}
  />
</CodeBlock>
...
<CodeBlock title="Error">
  <ExpandableSearchBar
    ...
    alwaysActive={true}
    message={{ text: "Okay, this is not cool.", type: SEARCHBAR_MESSAGE_TYPES.ERROR }}
  />
</CodeBlock>
